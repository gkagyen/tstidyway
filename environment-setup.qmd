...
=======
3.  Keep all scripts, data, and outputs in separate folders in your working directory for better workflow.

## Quick Test Run

Let's run a quick test to ensure everything is working. We shall use a built in dataset from the `fpp3` package.
>>>>>>> 23f0be6c15cccb513947fd43e0e191a9772a4bb6
