...
Before diving into analysis, let's make sure we have all the **tools** we need to get ready. We need to set up our R environment with the right tools. The **`tidyverts`** ecosystem — built around the **`tidyverse`** — makes time series analysis intuitive, consistent and visually appealing.
...
-   @sec-required-packages: This chapter will cover all the packages we will need, how to install and load them for use in our R environment.
