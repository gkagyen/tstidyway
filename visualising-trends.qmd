...
In the next chapter we will delve into a more detailed visualisation of seasonal patterns and trends.

::: callout-important
The `gg_season()` function is part of the `feasts` package but has been **deprecated** and moved to the new `ggtime` package which is basically designed for visualising time series patterns. It contains functions for exploring time series patterns like trends, seasonality, cycles and holidays.
:::
