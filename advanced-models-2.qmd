...
#| warning: false
#| label: fig-view-ts
#| fig-cap: "Visual Representation Of Annual Cereal Yield in Ghan from 1960 to 2007"
training_yield |> 
  autoplot(value)
```
...
#| fig-cap: "Autocorrelation Function Plot Annual Cereal Yield from 1960 to 2017"
...
```{r}
#| label: fig-qq-arima
#| fig-cap: "QUantile Quantile Plot of ARIMA Model Residuals"
augment(manual_arima) |> 
