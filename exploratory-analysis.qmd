...
-   @sec-exploring-patterns-with-feasts: Here we will dive deep into the `feasts` package, which provides specialised tools for time series exploration. You will discover how to
